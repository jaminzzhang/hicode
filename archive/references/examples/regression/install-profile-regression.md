...
本文件用于验证 `references/init/` 中的 manifest/profile 是否保持 `DAILY/LIBRARY` 分层、完整轻量闭环和 Hook 可选安装边界。
...
| 类型 | 路径 |
|---|---|
| Profile | `references/init/profiles/core.json` |
| Manifest | `references/init/manifests/agents.json`、`prompts.json`、`skills.json`、`gates.json`、`schemas.json`、`docs.json` |
| 入口 | `references/target-project/AGENTS.md` |
...
| 类型 | 路径 |
|---|---|
| Profile | `references/init/profiles/java-insurance-core.json` |
| Manifest | `references/init/manifests/agents.json`、`docs.json` |
| 专项 Agent | `agents/java-reviewer.md`、`security-reviewer.md` |
...
| 类型 | 路径 |
|---|---|
| Profile | `references/init/profiles/full-library.json` |
| Manifest | `references/init/manifests/*.json` |
...
| 类型 | 路径 |
|---|---|
| Manifest | `references/init/manifests/agents.json`、`prompts.json`、`skills.json`、`gates.json`、`docs.json`、`examples.json` |
| 安装说明 | `references/init/README.md` |
...
| 类型 | 路径 |
|---|---|
| Hook Manifest | `references/init/manifests/hooks.json` |
| Hook 规范 | `references/hooks/README.md`、`references/hooks/hook.json` |
| Profile | `references/init/profiles/core.json`、`java-insurance-core.json`、`full-library.json` |
