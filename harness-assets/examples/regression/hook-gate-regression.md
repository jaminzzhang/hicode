...
| 类型 | 路径 |
|---|---|
| Hook 说明 | `harness-assets/hooks/coding-entry-gate-hook.md` |
| Hook 配置 | `harness-assets/hooks/hook.json` |
| Gate | `harness-assets/gates/coding-entry-gate.md` |
| Schema | `harness-assets/schemas/gate-result.schema.json` |
...
| 类型 | 路径 |
|---|---|
| Hook 说明 | `harness-assets/hooks/merge-gate-hook.md` |
| Hook 配置 | `harness-assets/hooks/hook.json` |
...
| Hook 配置 | `harness-assets/hooks/hook.json` |
| Gate | `harness-assets/gates/merge-gate.md` |
| Review Prompt | `harness-assets/prompts/code-review.md` |
...
| 类型 | 路径 |
|---|---|
| Hook 说明 | `harness-assets/hooks/coding-entry-gate-hook.md`、`merge-gate-hook.md` |
| Hook 规范 | `harness-assets/hooks/README.md` |
| 权限矩阵 | `harness-assets/docs/TOOL_PERMISSION_AUDIT_MATRIX.md` |
