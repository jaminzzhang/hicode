...
本文件用于验证 `harness-assets/agents/`、`harness-assets/docs/AGENT_PROMPT_INTEGRATION.md` 和 `harness-assets/docs/workflows/agent-delegation.md` 是否能在目标项目中保持 V1 风险闭环。
...
| 类型 | 路径 |
|---|---|
| Agent | `harness-assets/agents/requirement-reviewer.md` |
| Prompt | `harness-assets/prompts/requirement-review.md` |
| Skill | `harness-assets/skills/requirement-review/SKILL.md` |
| 整合规范 | `harness-assets/docs/AGENT_PROMPT_INTEGRATION.md` |
| 委托流程 | `harness-assets/docs/workflows/agent-delegation.md` |
...
| 类型 | 路径 |
|---|---|
| Agent | `harness-assets/agents/coding-planner.md` |
| Skill | `harness-assets/skills/coding-plan/SKILL.md` |
| 整合规范 | `harness-assets/docs/AGENT_PROMPT_INTEGRATION.md` |
| 委托流程 | `harness-assets/docs/workflows/agent-delegation.md` |
...
| 类型 | 路径 |
|---|---|
| Agent | `harness-assets/agents/code-reviewer.md` |
| Prompt | `harness-assets/prompts/code-review.md` |
| Skill | `harness-assets/skills/code-review/SKILL.md` |
| Gate | `harness-assets/gates/merge-gate.md` |
| Schema | `harness-assets/schemas/review-result.schema.json`、`harness-assets/schemas/gate-result.schema.json` |
...
| 类型 | 路径 |
|---|---|
| Agent | `harness-assets/agents/code-reviewer.md`、`java-reviewer.md`、`security-reviewer.md` |
...
| 类型 | 路径 |
|---|---|
| Agent | `harness-assets/agents/security-reviewer.md` |
| 整合规范 | `harness-assets/docs/AGENT_PROMPT_INTEGRATION.md` |
| 委托流程 | `harness-assets/docs/workflows/agent-delegation.md` |
| 权限矩阵 | `harness-assets/docs/TOOL_PERMISSION_AUDIT_MATRIX.md` |
