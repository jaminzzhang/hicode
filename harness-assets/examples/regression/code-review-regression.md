...
验证 `harness-assets/prompts/code-review.md`、`harness-assets/skills/code-review/` 和 `harness-assets/schemas/review-result.schema.json` 是否能稳定识别代码审查中的 P1 需求轴和规范轴问题。
...
| 输出模板 | `harness-assets/skills/code-review/output-template.md` |
| Schema | `harness-assets/schemas/review-result.schema.json` |
