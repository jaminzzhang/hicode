...
P4-WP1 只定义验证要求，不创建具体示例。具体示例由 P4-WP7 放入 `harness-assets/examples/`。

## 10. P4 计划中的 Skill 清单

| 场景 | Skill 目录 | 对应 Prompt |
|---|---|---|
| 需求评审 | `requirement-review/` | `harness-assets/prompts/requirement-review.md` |
| 编码计划 | `coding-plan/` | `harness-assets/prompts/coding-plan.md` |
| TDD | `tdd/` | `harness-assets/prompts/tdd.md` |
| 辅助编码 | `coding-assistant/` | `harness-assets/prompts/coding-assistant.md` |
| 代码审查 | `code-review/` | `harness-assets/prompts/code-review.md` |
| 提交检查 | `pre-commit-check/` | `harness-assets/prompts/pre-commit-check.md` |
| 核心场景测试 | `core-scenario-test/` | `harness-assets/prompts/core-scenario-test.md` |
| 发布检查 | `release-check/` | `harness-assets/prompts/release-check.md` |
