...
| `source` | 本仓库源资产路径，例如 `harness-assets/agents/code-reviewer.md` |
...
| `harness-assets/agents/*.md` | `.hicode/agents/*.md` | 子 Agent 源资产 |
| `harness-assets/prompts/*.md` | `.hicode/prompts/*.md` | Prompt 源资产 |
| `harness-assets/skills/*/` | `.hicode/skills/*/` | Skill 源资产 |
| `harness-assets/gates/*.md` | `.hicode/gates/*.md` | 门禁源资产 |
| `harness-assets/schemas/*.json` | `.hicode/schemas/*.json` | 结构化输出 Schema |
| `harness-assets/examples/` | `.hicode/examples/` | 脱敏示例和回归样例 |
| `harness-assets/docs/` | `docs/` 或 `.hicode/docs/` | 人读文档默认进入目标项目 `docs/`；若仅供 Agent 检索，可由 profile 映射到 `.hicode/docs/` |
