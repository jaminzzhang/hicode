...
2. `.claude-plugin/plugin.json` 不暴露本仓库 `docs/`、`archive/` 或历史 references 目录。
...
3. 后续修改 `skills/`、`agents/`、`references/`、`.claude-plugin/` 或 `install.sh` 后，应重新运行健康检查。
