...
hicode 的目标项目范围按“高严谨业务系统”定义：金融、保险及类金融系统是重点场景，同时覆盖其他对业务规则严谨性、逻辑边界、交易或数据一致性、可审计性有同等级要求的系统。
...
15. hicode 以高严谨业务系统为目标项目边界；金融、保险及类金融系统是重点场景，但其他具备同等级业务规则严谨性、逻辑边界、交易或数据一致性、可审计性要求的系统同样适用。
...
1. 不实现金融、类金融、其他高严谨业务系统或试点业务系统代码。
...
1. 不保留当前 JSON Schema。
2. 共享规则短小，不成为长篇指南集合。
3. 覆盖高严谨业务系统风险基线，并保留金融、保险及类金融重点场景。
...
2. 能按需读取对应场景规则和模板。
3. 保留高严谨业务系统风险标准、金融及类金融重点场景、测试先行和受限命令边界。
...
3. 高严谨业务系统风险标准、安全红线、人工审批边界和生产禁止事项仍然保留。
