...
| 目录 | 用途 | 目标项目建议位置 |
|---|---|
| `project/` | 项目全局共享模板，用于入口、长期领域知识、项目结构上下文和 ADR | 项目根目录、`docs/`、`docs/adr/` |
...
| 目录 | 文件 |
|---|---|
| `project/` | `AGENTS.md`、`CLAUDE.md`、`DOMAIN_KNOWLEDGE.md`、`PROJ_CONTEXT.md`、`ADR-template.md` |
...
| 文档 | 层级 | 说明 | 正式写入规则 |
|---|---|---|---|
| `AGENTS.md` / `CLAUDE.md` | 项目全局 | Coding Agent 入口、上下文索引、安全边界和 Skill 路由 | 初始化或负责人确认后写入 |
...
| `release-report.md` | 单需求特性 | 发布材料、核心场景测试、回滚和生产验证计划检查 | Release 过程生成 |
